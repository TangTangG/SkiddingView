...
/**
 * Created by TCG on 2017/8/22.
 * desc:copy from -->
 * url:https://github.com/android/platform_frameworks_support/blob/master/core-ui/java/android/support/v4/widget/ViewDragHelper.java
 * path:platform_frameworks_support/core-ui/java/android/support/v4/widget/ViewDragHelper.java
 */

public class SimpleDragHelper {
        private static final String TAG = "SimpleDragHelper";
        ...
        /**
         * A Callback is used as a communication channel with the SimpleDragHelper back to the
         * parent view using it. <code>on*</code>methods are invoked on siginficant events and several
         * accessor methods are expected to provide the SimpleDragHelper with more information
        ...
        public abstract static class Callback {
             ...
             * one of these methods, the SimpleDragHelper will enter {@link #STATE_SETTLING}
             * and the view capture will not fully end until it comes to a complete stop.
             * If neither of these methods is invoked before <code>onViewReleased</code> returns,
             * the view will stop in place and the SimpleDragHelper will return to
             * {@link #STATE_IDLE}.</p>
             *
             ...
             *
             * <p>SimpleDragHelper may call this method multiple times for the same view even if
        ...
        /**
         * Factory method to create a new SimpleDragHelper.
         *
         * @param forParent Parent view to monitor
         * @param cb Callback to provide information and receive events
         * @return a new SimpleDragHelper instance
         */
        public static SimpleDragHelper create(ViewGroup forParent, Callback cb) {
            return new SimpleDragHelper(forParent.getContext(), forParent, cb);
        }
         ...
         * @return a new SimpleDragHelper instance
         */
        public static SimpleDragHelper create(ViewGroup forParent, float sensitivity, Callback cb) {
            final SimpleDragHelper helper = create(forParent, cb);
            helper.mTouchSlop = (int) (helper.mTouchSlop * (1 / sensitivity));
            return helper;
        }

        /**
         * Apps should use SimpleDragHelper.create() to get a new instance.
         ...
         * @param forParent Parent view to monitor
         */
        private SimpleDragHelper(Context context, ViewGroup forParent, Callback cb) {
            if (forParent == null) {
        ...
        public void captureChildView(View childView, int activePointerId) {
            if (childView.getParent() != mParentView) {
                throw new IllegalArgumentException("captureChildView: parameter must be a descendant "
                        + "of the SimpleDragHelper's tracked parent view (" + mParentView + ")");
            }
         ...
         * of the SimpleDragHelper's knowledge).
         *
        ...
        public boolean shouldInterceptTouchEvent(MotionEvent ev) {
            ...
            switch (action) {
                ...
                case MotionEventCompat.ACTION_POINTER_DOWN: {
                    ...
                    // A SimpleDragHelper can only manipulate one view at a time.
                    if (mDragState == STATE_IDLE) {
                        final int edgesTouched = mInitialEdgesTouched[pointerId];
                        if ((edgesTouched & mTrackingEdges) != 0) {
                            mCallback.onEdgeTouched(edgesTouched & mTrackingEdges, pointerId);
        ...
        private boolean isValidPointerForActionMove(int pointerId) {
            if (!isPointerDown(pointerId)) {
                Log.e(TAG, "Ignoring pointerId=" + pointerId + " because ACTION_DOWN was not received "
                        ...
                        + " SimpleDragHelper did not receive all the events in the event stream.");
                return false;
            }
            return true;
        }
